...
# Watcher primitives now live in printwatcher/core.py so the FastAPI backend
# (planned for v0.4) can share them. Re-imported into module scope so the
# legacy Tk UI keeps its existing references working unchanged.
from printwatcher.core import (
    ...
    DEFAULT_THEME,
    EXTS,
    FILENAME_OPTIONS_SEPARATOR,
    FILENAME_TOKEN_SPLIT,
    HistoryStore,
    InboxHandler,
    LOG_LINE_LIMIT,
    POLL_INTERVAL_SEC,
...
# load_preferences / save_preferences live in printwatcher.core (re-imported
